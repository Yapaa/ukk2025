...
class PetugasController extends AppController
{
    ...
    public function index()
    {
        ...
        if($level=='admin'){
            ...
            ['conditions' => ['OR'=>['id'=>$id,'level'=>'masyarakat']]]));
        }else{
        ...
        if($id!=$idku) {
            if($id!=$idku){
                if ($this->Petugas->delete($petuga)) {
                    $this->Flash->success(__('The petugas has been deleted.'));
                } else {
                    $this->Flash->error(__('The petugas could not be deleted. Please, try again.'));
                }
            } else {
